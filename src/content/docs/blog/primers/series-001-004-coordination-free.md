...
```mermaid
graph TD
    Hash["Shared constant: seed + hash function"]
    Hash -.-> HQ["HQ Node<br>Learn, mint engrams"]
    Hash -.-> Edge["Edge Node<br>Encode, score, act"]
    HQ -->|"Serialized engram"| Edge
    Edge --> Score["Residual scoring<br>against engram subspace"]
```
