...
So: trust the concepts, expect the syntax to read much more like Clojure soon. The migration is being written **live** in the **[Arc 170 realizations](/blog/realizations/170-program-entry-points/)** — the Book paused at its intermissions to "do a quick update," and that update became this six-week push to a faithful Clojure surface; you can read it land entry by entry there. The broader story is in the [Story track](/blog/story/prologue/) and [the Book](/blog/book/).
:::
