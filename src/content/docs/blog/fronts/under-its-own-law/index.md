---
title: "wat Under Its Own Law"
description: "The front where the language is made subject to the discipline it imposes on its users. Every law wat enforces outward — purity, totality, honest optionality, one reader for one surface — turned on wat's own body."
...
> `WAT-MUST-OBEY-ITS-OWN-LAW` · `THE-LAW-SPARES-NO-ONE-NOT-EVEN-WAT-ITSELF` · `NE-SIBI-OBSOLESCAT`
...
Ordered by the event that triggered them — a closure, a reversal, a campaign, an incident — not by the calendar. Some weeks hold several; some hold none.
