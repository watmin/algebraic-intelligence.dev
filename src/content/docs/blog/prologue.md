...
Two weeks from starting to write code to a working demo. Real anomaly detection on real network traffic. F1 of 1.0 on the first serious challenge. That's what a year of mental model building looks like when it meets the right tools. The speed was unlike anything I'd experienced. Years of work in weeks. That's not hyperbole.
