...
For depth: the Book trunk (`/blog/book.md`, ~36k lines) is the full philosophical record — read it whole as raw markdown, or browse it chapter-by-chapter from `/blog/book/`. Its running meta-conversation is the [arc-170 realizations](/blog/realizations/170-program-entry-points/) branch. The [primers](/blog/primers/series-001-000-vsa-primer/) teach VSA/HDC from scratch.
