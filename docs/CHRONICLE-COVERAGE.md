...
| `wat-rs` | Substrate — the live edge | `26b088b5` (06-17) | era **"The Self-Fixing Toolchain"** (`series-006-031` — arcs **275/277/279/281/284**) · era **"The Unforgeable Reference"** (`series-006-032` — arc **272**) · era **"Coherence Is the Engine"** (`series-006-033` — arc **260**) · era **"Landing on the Greats"** (`series-006-034` "The Slow Engine Is the Spec" — arc **278** the rete engine: dual-impl/oracle, outran Clara@AWS; engine done, arc not formally closed — collection side-quests for user-supplied query fns remain · `series-006-035` "Time Is a Select" — arc **292** CLOSED: time-as-I/O, the tier-fusing typed timer) | **283** shipped (SourceFile dogfood rename) — minor. **HORIZON / NOT yet narratable:** 282 wat-fix-over-Rust (STUB) · 251 the great migration (syntax fixes remain) · 285 + the 278 collection tail · the VSA-matched-LHS seam (designed, unbuilt) |
