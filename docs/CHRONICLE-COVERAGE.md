...
| `holon-lab-trading` | Trading lab + **BOOK true source** | `923eb62` (06-10, BOOK Interm. XII "Contumacia") | series-006-001/002/003; the BOOK serves via `mirror-monoliths` → `public/blog/book.md` (**through XII, 06-10**) + per-chunk `/blog/book/<n>.md` | story covers the lab; the BOOK/intermissions serve raw + chunked, not chronicle-narrated |
