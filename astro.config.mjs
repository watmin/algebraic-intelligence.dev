    ...
    starlight({
      ...
      sidebar: [
        ...
        },
        {
          ...
          {
            // SIDEBAR CONVENTION: every group on this site ships COLLAPSED.
            // The nav is long — 85 narrative posts across 12 autogenerated
            // groups — and a group that opens on load buries its siblings off
            // the bottom of the viewport. These six were the only `false` on the
            // page and they were all added in one sitting; the other 24 groups
            // had it right. If a group should ever open by default, that is a
            // deliberate choice and it needs a comment saying why.
            label: "The Fronts",
            collapsed: true,
            items: [
              { slug: "blog/fronts" },
          ...
          items: [
            ...
            // arc + an index landing) and autogenerated here, so new arcs appear
            // on the next mirror run with zero nav edits. The index (order 0) leads.
            {
              label: "Realizations — All Arcs",
              collapsed: true,
              autogenerate: { directory: "blog/realizations" },
            },
        ...
        { slug: "blog/story/epilogue" },
        {
          ...
          items: [
            ...
            { slug: "blog/witness/005-not-by-my-hand" },
          ],
        },
        {
          ...
          items: [
            ...
            },
            {
              ...
              items: [
                ...
                { slug: "fenestra-aetherii/warhammer-fantasy" },
                { slug: "fenestra-aetherii/forgotten-realms" },
                { slug: "fenestra-aetherii/dungeons-and-dragons" },
                { slug: "fenestra-aetherii/shadowrun" },
              ],
            },
            {
              label: "The Masters",
            ...
            },
            {
              ...
              items: [
                ...
                { slug: "fenestra-aetherii/stained-glass-ii" },
                { slug: "fenestra-aetherii/stained-glass-iii" },
                { slug: "fenestra-aetherii/stained-glass-iv" },
                { slug: "fenestra-aetherii/stained-glass-v" },
                { slug: "fenestra-aetherii/crusader-knights" },
                { slug: "fenestra-aetherii/crusader-battlefield" },
